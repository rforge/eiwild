...
#' 
#' It enabels to estimate the inner cells of an RxC-table with aggregate data with 
#' a number of precints and/or individual level data for a few precincts.
#' 
...
#' 2x2-tables. In the master thesis of Thomas Schlesinter (2013) he expanded the 2x2-case
...
#' 
#' It is a hirachircal bayesian model which uses MCMC-Algorithms to calculate the
#' estimations. Therefore it has all the pros and cons of these methods.
#' 
#' The typical workflow consists of 
#' \enumerate{
#'   \item Formating your data in the accapted way. 
